    ...
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href="/panel/dashboardadmin">
                <img src="{{ asset('tabler/static/logo-bpkad.png') }}" width="110" height="32" alt="Tabler"
        ...
        <div class="navbar-nav flex-row d-lg-none">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    @php
                        $user = Auth::guard('user')->user(); // Menggunakan guard untuk 'user'
                        $defaultPhoto = 'assets/img/nophoto.png'; // Path ke avatar default
            
                        if (!empty($user->photo) && $user->photo != 'nophoto.png') {
                            $path = Storage::url('uploads/admin/' . $user->photo); // Path untuk foto user
                        } else {
                            $path = asset($defaultPhoto);
                        }
                    @endphp
                    <span class="avatar avatar-sm" style="background-image: url('{{ url($path) }}')"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <a href="/presensi/profileadmin" class="dropdown-item">Profile</a>
                    <a href="/admin" class="dropdown-item">Logout</a>
                </div>
            </div>            
        </div>
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['karyawan','unitkerja']) ? 'show' : '' }}" 
                        href="#navbar-base" data-bs-toggle="dropdown"
                        data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['karyawan','unitkerja']) ? 'true' : '' }}">
                        <span
                    ...
                    <div class="dropdown-menu {{ request()->is(['karyawan','unitkerja','user']) ? 'show' : '' }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is(['presensi/monitoringpresensi']) ? 'active' : '' }}" href="/presensi/monitoringpresensi">
                        <span
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is(['presensi/izinsakit']) ? 'active' : '' }}" href="/presensi/izinsakit">
                        ...
                        <span class="nav-link-title">
                            ...
                            <span class="badge bg-danger d-inline-flex align-items-center">{{ $pendingCount }}</span>
                            @endif
                        </span>
                    </a>
                </li>
